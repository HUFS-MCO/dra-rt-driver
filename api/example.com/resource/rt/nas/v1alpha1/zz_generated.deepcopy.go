...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AllocatableRtCpu) DeepCopyInto(out *AllocatableRtCpu) {
	*out = *in
	if in.RtCpu != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllocatableRtCpu.
func (in *AllocatableRtCpu) DeepCopy() *AllocatableRtCpu {
	if in == nil {
		return nil
	}
	out := new(AllocatableRtCpu)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeAllocationStateSpec) DeepCopyInto(out *NodeAllocationStateSpec) {
	*out = *in
	if in.AllocatableRtCpu != nil {
		in, out := &in.AllocatableRtCpu, &out.AllocatableRtCpu
		*out = make([]AllocatableRtCpu, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.AllocatedClaims != nil {
		...
		*out = make(map[string]AllocatedRtCpu, len(*in))
	...
	if in.PreparedClaims != nil {
		...
		*out = make(map[string]PreparedRtCpu, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
