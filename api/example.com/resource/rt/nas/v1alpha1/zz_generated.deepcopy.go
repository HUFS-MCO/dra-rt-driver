...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AllocatedPodCgroup) DeepCopyInto(out *AllocatedPodCgroup) {
	*out = *in
	if in.PodRuntime != nil {
		in, out := &in.PodRuntime, &out.PodRuntime
	...
	if in.PodPeriod != nil {
		in, out := &in.PodPeriod, &out.PodPeriod
		*out = make(MappedCgroup, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AllocatedPodCgroup.
func (in *AllocatedPodCgroup) DeepCopy() *AllocatedPodCgroup {
	if in == nil {
		return nil
	}
	out := new(AllocatedPodCgroup)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NodeAllocationStateSpec) DeepCopyInto(out *NodeAllocationStateSpec) {
	*out = *in
	...
	if in.AllocatedPodCgroups != nil {
		...
		*out = make(map[string]AllocatedPodCgroup, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
