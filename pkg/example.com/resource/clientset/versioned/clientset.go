...
type Interface interface {
	...
	RtV1alpha1() rtv1alpha1.RtV1alpha1Interface
}
...
type Clientset struct {
	*discovery.DiscoveryClient
	...
	rtV1alpha1  *rtv1alpha1.RtV1alpha1Client
}
...
// RtV1alpha1 retrieves the RtV1alpha1Client
func (c *Clientset) RtV1alpha1() rtv1alpha1.RtV1alpha1Interface {
	return c.rtV1alpha1
}
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	cs.rtV1alpha1, err = rtv1alpha1.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	...
	cs.rtV1alpha1 = rtv1alpha1.New(c)
